...
void __attribute__((picinterrupt(("")))) isr (void){
    ...
    if(PIR1bits.RCIF){
        ...
        if (entrada_terminal < 5){
            ...
            if(estado == 1){
                if(entrada_terminal == 3){
                    write_EEPROM(1, pot1);
                }
                if(entrada_terminal == 2){
                    write_EEPROM(2, pot2);
                }
                if(entrada_terminal == 1){
                    write_EEPROM(3, pot3);
                }
                if(entrada_terminal == 0){
                    write_EEPROM(4, pot4);
                }
            }
            else if(estado == 2){
...
void main(void) {
    ...
    while(1){
        ...
        if(PIR1bits.TXIF){
            if(bandera == 1){
                TXREG = 0b00000001 | pot3;
                bandera = 0;
            }
            else{
                TXREG = 0b11111110 & pot4;
                bandera = 1;
            }
        }
        if(estado == 1){
